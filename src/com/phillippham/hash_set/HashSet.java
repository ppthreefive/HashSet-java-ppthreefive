package com.phillippham.hash_set;
...
public class HashSet<T>
{
	...
	public void insert(T data)
	{
		...
		if(this.dataTable[hash] == null)
		{
			...
			this.dataTable[hash].add(data);
		}
		else if(!this.dataTable[hash].contains(data))
		{
			// Add data to the LinkedList at that specific slot if it doesn't already exist
			this.dataTable[hash].add(data);
		}
		else
		{
